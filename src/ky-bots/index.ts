...
const data: Buffer[] = []; // This buffer contain the split messages depending the chunk size
...
export const speak = async (channel: IChannel) => {
    ...
    try {
        ...
        const bufferStream = fs.createReadStream('./nasa-speak.mp3', { highWaterMark: (128 * 1024) * 5 });
